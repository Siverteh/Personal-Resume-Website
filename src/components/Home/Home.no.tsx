    ...
    return (
        <div className="home-container">
            <div className="intro-wrapper">
                ...
                <p>Velkommen til min personlige portefølje. Jeg er en lidenskapelig Kunstig Intelligens Student / Utvikler med fokus på å bygge skalerbare og effektive løsninger. Ta en titt rundt for å se mitt arbeid, ferdigheter og prosjekter.</p>
