    ...
    return (
        <div className="home-container">
            <div className="intro-wrapper">
                ...
                <p>Welcome to my personal portfolio. I'm a passionate Artificial Intelligence Student / Developer with a focus on building scalable and efficient solutions. Take a look around to see my work, skills, and projects.</p>
