            ...
            <div className="timeline">
                <div className="timeline-item">
                    <div className="timeline-content">
                        ...
                        <h3>Master in Artificial Intelligence</h3>
                        ...
                        <p className="timeline-description">Currently pursuing a Master's degree in Artificial Intelligence, with a focus on machine learning, intelligent system design, and advanced AI techniques.</p>
                    </div>
                </div>
                <div className="timeline-item">
                    <div className="timeline-content">
